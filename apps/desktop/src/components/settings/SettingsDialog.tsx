                  ...
                  {c === 'Agents' && (
                    <div className="mt-6">
                      ...
                      <p className="settings-disclosure-box">
                        Set parallel capacity in each project's task queue. Automatic failover, task
                        timeouts and completion alerts are still planned.
                      </p>
                    </div>
                  )}
                  {c === 'Privacy' && (
                      ...
                      {!project ? (
                        ...
                        <>
                          ...
                          <div className="settings-group">
                            <Setting
                              title="Project name"
                              description="Label shown in the project switcher."
                            >
                              <input

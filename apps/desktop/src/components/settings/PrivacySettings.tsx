...
export function PrivacySettings({ welcome = false }: { welcome?: boolean }) {
  ...
  return (
    <section className="space-y-4" aria-label="Usage privacy">
      ...
      <p className="settings-row-description">
        Sharing is optional. Your choice saves immediately in Settings. You can turn it off in
        Settings → Privacy at any time. Sending written feedback is a separate action.
      </p>
      {welcome && (

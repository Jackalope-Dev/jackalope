  ...
  return (
    <div className="planning-page">
      ...
      <WorkspaceHeading
        ...
        action={
          <Button onClick={projectId ? handleOpenNew : onOpenProject} size="sm">
            <Plus className="size-3.5" />
            {projectId ? 'New idea' : 'Open project'}
          </Button>
        }
      />
      ...
      {!projectId ? (
        <EmptyState
          ...
          description="Keep ideas with the repository they belong to."
        />
      ) : (
        <section
      ...
      {isModalOpen && (
        <TaskModal
          key={`${projectId}:${selectedTaskId ?? 'new'}`}

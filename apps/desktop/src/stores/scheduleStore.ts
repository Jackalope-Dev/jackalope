      ...
      schedules: [
        {
          ...
          description:
            'Runs audit tool, checks for CVEs, and drafts upgrade worktrees if patches exist.',
          cronExpression: '0 2 * * *',
          targetProjectId: 'jackalope-core',
          assignedAgentProvider: 'Agent Antigravity',
          prompt:
            'Check all package.json and Cargo.lock dependencies for vulnerabilities and deprecated APIs.',
          enabled: true,
          lastRun: {
        ...
        },
        {
          ...
          description:
            'Executes typecheck and unit tests against active worktree branches to catch regressions.',
          cronExpression: '0 * * * *',
          targetProjectId: 'jackalope-core',
        ...
        },
        {
          ...
          description:
            'Identifies merged worktrees with no active processes and safely frees disk space.',
          cronExpression: '0 0 * * 0',
          targetProjectId: 'jackalope-core',
          assignedAgentProvider: 'Local Ollama',
          prompt:
            'Inspect git worktree list and remove directories whose branches are merged into main.',
          enabled: false,

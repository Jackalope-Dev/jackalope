...
export const VETTED_SKILLS: SkillDefinition[] = [
  {
    ...
    guidelines: [
      ...
      'Verify the fix and affected behavior, including repository-required checks. Repeat successful checks only after relevant changes, failures or unresolved concerns.',
    ],
  ...
  },
  {
    ...
    guidelines: [
      ...
      'Run repository-required checks and the build, typecheck or behavioral checks relevant to the changed code.',
    ],
  ...
  },
  {
    ...
    guidelines: [
      ...
      'Cover boundaries and failure modes affected by this change; avoid tests that only restate implementation details.',
  ...
  },
  {
    ...
    guidelines: [
      ...
      'Review dependency vulnerabilities when dependencies change or the task requests an audit.',
    ],
    suggestedTools: ['filesystem', 'git'],
  },
  {
  ...
  },
  {
    ...
    guidelines: [
      ...
      'Verify the combined workspace with repository-required checks and checks covering the affected behavior before requesting integration.',
    ],
    suggestedTools: ['git'],
  },
  {

    ...
    <>
      ...
      <header className="site-header">
        <div className="header-inner">
          <a href="#main" className="wordmark" aria-label="Jackalope home">
            <BrandMark />
            Jackalope
          </a>
      ...
      <main id="main">
        <section className="hero page-width" aria-labelledby="hero-title">
          ...
          <p className="hero-description">
            ...
            <br className="desktop-break" /> Meet the desktop workspace that keeps it all together.
          </p>
          ...
          <Reveal className="hero-product">
            <div className="product-surround">
            ...
            {downloadUrl ? (
              ...
              <Dialog.Root>
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="release-dialog">
                    <Dialog.Close
                    ...
                    <Dialog.Title>A little more growing room.</Dialog.Title>
                    <Dialog.Description>
                      The first Windows release is being prepared. There isn’t a public download
                      just yet.
                    </Dialog.Description>
                    <p>
                      When it’s ready, you’ll find the Windows x64 installer right here. You’ll need
                      a local Git repository and a signed-in Codex or Claude Code installation.
                    </p>

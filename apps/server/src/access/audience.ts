...
export function audienceEligible(
  member: Pick<MemberRow, 'newsletter' | 'newsletter_confirmed_at' | 'status'>,
) {
  return (
    member.newsletter === 1 &&
    typeof member.newsletter_confirmed_at === 'number' &&
    member.newsletter_confirmed_at > 0 &&

...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif"><tr><td style="padding-bottom:22px;border-bottom:2px solid ${colors['--color-text-primary']};font-size:22px;font-weight:700;letter-spacing:-1px">Jackalope<span style="color:${colors['--color-accent-ink']}"> /</span></td><td align="right" style="padding-bottom:22px;border-bottom:2px solid ${colors['--color-text-primary']}"><img src="${escapeHtml(origin)}/icon-128.png" width="42" height="42" alt="" style="display:block"></td></tr></table>
...
<p style="margin:32px 0 20px;font-size:16px;line-height:1.8;color:${colors['--color-text-secondary']}">We’ll email you as early-access places open. Windows comes first, with macOS and Linux planned.</p>
<p style="margin:0 0 36px"><a href="${escapeHtml(origin)}/tour/" style="display:inline-block;padding:12px 0;font-size:17px;font-weight:700;text-decoration:none;border-bottom:2px solid ${colors['--color-accent']};color:${colors['--color-text-primary']}">Take a look inside &nearr;</a></p>

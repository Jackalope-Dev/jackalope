...
Manual tasks now appear in the project inventory with explicitly unknown scopes.
...
Claude Code and Grok now have standalone capacity readers. Claude is initialized in

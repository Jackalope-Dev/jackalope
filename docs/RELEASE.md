...
Acceptance covers clean-machine and signed-upgrade trials, real account lifecycle,
...
external beta evidence. See [contributor priorities](TODO.md) for outstanding work.
